...
import { MachineStatus, PurchaseType, NationalType } from '@generated/prisma';
...
export class CreateAssetDto {
  ...
  @ApiProperty({
    example: 'Producción',
    description: 'Area where the asset is located',
  })
  @IsString()
  @IsNotEmpty()
  area: string;
  ...
  @ApiPropertyOptional({
    example: 10,
    description: 'Initial quantity (spare parts only)',
  })
  @IsOptional()
  @IsInt()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 8,
    description: 'Current quantity (spare parts only)',
  })
  @IsOptional()
  @IsInt()
  @Min(0)
  ...
  @ApiProperty({
    example: 'Camera Calibration Station',
  ...
  @ApiPropertyOptional({
    example: 'PED-2024-1234',
    description: 'Customs document (pedimento)',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    example: 'FAC-2024-5678',
    description: 'Invoice number (factura)',
  })
  @IsOptional()
  @IsString()
  invoice?: string;

  @ApiProperty({ example: 150000.5, description: 'Commercial value in MXN' })
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    example: 'High-precision calibration station for ADAS cameras',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiProperty({
    enum: PurchaseType,
    example: 'IMPORT',
    description: 'Import or National',
  })
  @IsEnum(PurchaseType)
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Whether this asset was purchased',
  })
  @IsOptional()
  @IsBoolean()
  isPurchased?: boolean;
