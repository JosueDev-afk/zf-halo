...
import { AuthorizeLoanDto } from '../../dtos/loan/authorize-loan.dto';
import { Loan } from '../../../domain/entities/loan.entity';

@Injectable()
export class AuthorizeLoanUseCase {
  constructor(
  ...
  async execute(
    ...
    LoanStateMachineService.validateTransition(loan.status, 'AUTHORIZED');
